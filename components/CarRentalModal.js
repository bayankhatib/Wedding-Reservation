...
const CarRentalModal = ({ visible, onClose, partnerGallery, partnerBasePrice, partnerLogo, partnerName, partnerId, partnerDiscount }) => {
  ...
  const handleLicenseValidated = () => {
    ...
    // Reset car selection when proceeding to booking
    setSelectedImage(null);
  };

  // Handle driving license modal close
  const handleDrivingLicenseClose = () => {
    setShowDrivingLicense(false);
    // Reset car selection when closing without continuing
    setSelectedImage(null);
  };
  ...
  // Debug logging
  console.log('CarRentalModal - partnerGallery:', partnerGallery);
  console.log('CarRentalModal - partnerImages:', partnerImages);
  console.log('CarRentalModal - partnerBasePrice:', partnerBasePrice);
  console.log('CarRentalModal - partnerId:', partnerId);
  console.log('CarRentalModal - partnerDiscount:', partnerDiscount);

  // Check if this partner should show both old and new prices (partner ID 14)
  const shouldShowOldPrice = partnerId === 13;
  ...
  return (
    <>
      <Modal
        animationType="slide"
        transparent={true}
        visible={visible && !showDrivingLicense && !showBookingProcess}
        ...
        >
          ...
          >
            ...
            <TouchableOpacity 
              ...
              <CustomText style={styles.bookingModalTitle}>تأجير السيارات</CustomText>
            </View>
            ...
            <View style={styles.gallerySection}>
              ...
              {imagePrices.length > 0 ? (
                ...
                <View style={styles.noImagesContainer}>
                  <CustomText style={styles.noImagesText}>لا توجد صور سيارات متاحة</CustomText>
                  <CustomText style={styles.noImagesSubtext}>يرجى التواصل مع الشريك للحصول على صور السيارات</CustomText>
                </View>
              )}
            </View>
            ...
            <TouchableOpacity 
              style={[
                ...
                !selectedImage && styles.checkoutButtonDisabled
              ]}
      ...
      <DrivingLicenseModal
        visible={showDrivingLicense}
        onClose={handleDrivingLicenseClose}
